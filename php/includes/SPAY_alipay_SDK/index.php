...
<html>
	<head>
	<title>SPAY免签约支付宝即时到账交易接口接口</title>
	...
	<div id="main">
		<div id="head">
            <dl class="alipay_link">
                <a target="_blank" href="http://spay.swapteam.cn/"><span>免签约申请地址</span></a>
            </dl>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDout_trade_no" value="<?php echo date("YmdHis").mt_rand(100000,999999); ?>"/>
